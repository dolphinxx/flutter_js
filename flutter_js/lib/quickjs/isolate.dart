...
//
//   late final QuickJsRuntime2 qjs;
//
...
//       stackSize: stackSize,
//       hostPromiseRejectionHandler: (reason) {
//         hostPromiseRejection(reason: reason);
//       },
//       moduleHandler: (name) {
//         final ptr = calloc<Pointer<Utf8>>();
//         ptr.value = Pointer.fromAddress(ptr.address);
//         module(ptr: ptr.address, name: name);
//         // sendPort.send({
//         //   #type: #module,
//         //   #name: name,
//         //   #ptr: ptr.address,
...
//   }
//
//   Future<void> module({required int ptr, required String name}) async {
//     final _ptr = Pointer<Pointer>.fromAddress(ptr);
//     try {
//       _ptr.value = (await moduleHandler!(name)).toNativeUtf8();
//     } catch (e) {
//         _ptr.value = Pointer.fromAddress(-1);
//     }
//   }
//
//
...
//     //   stackSize: stackSize,
//     //   hostPromiseRejectionHandler: (reason) {
//     //     hostPromiseRejection(reason: _encodeData(reason));
//     //   },
//     //   moduleHandler: (name) {
//     //     final ptr = calloc<Pointer<Utf8>>();
//     //     ptr.value = Pointer.fromAddress(ptr.address);
...
//     // _ensureEngine();
//     try {
//       final result = qjs.evaluate(command, name: name, evalFlags: evalFlags);
//       return result;
//     } catch (e) {
//       throw e;
//     }
